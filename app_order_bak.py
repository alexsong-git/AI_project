...
S3_BASE_PATH = "expect/order"
S3_RESPONSE_PATH = "response/order"  # response存储路径
S3_HTML_BODY_PATH = "html_body/order"  # html body存储路径
...
def extract_base_identifier(filename):
    ...
    # 匹配模式: 提取类似"order_row2"的基础标识符
    match = re.search(r'(order_row\d+)', filename)
