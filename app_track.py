...
S3_BASE_PATH = "expect/track"
S3_RESPONSE_PATH = "response/track"  # response存储路径
S3_HTML_BODY_PATH = "html_body/track"  # html body存储路径
...
def extract_base_identifier(filename):
    ...
    match = re.search(r'(track_row\d+)', filename)
